...
($k_{\mathrm{eq}}=20$, 192 ориентации SO(3), $N_\phi=288$,
...
\midrule
\endhead
Точный FP64 & 10,98 с & 1,00 & контрольный результат \\
Точный смешанный FP32 & 6,51 с & 1,69 & общая $L_2=9{,}05\cdot10^{-8}$ \\
FP32 с быстрыми функциями & 7,01 с & 1,57 & общая $L_2=9{,}04\cdot10^{-8}$ \\
\bottomrule
\end{longtable}
