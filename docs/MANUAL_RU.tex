...
V100/A100 сохраняется warp-путь. При блоке 64 потребительский путь также
использует плитку $16\,\theta\times4\,\phi$, если неполные краевые плитки
добавляют не более 15\% работы. Это убирает два целочисленных деления на
выходной поток; в проверке полное время изменилось на 0--11\% в сторону
ускорения. Переменная \code{MBS_GPU_TIMING=1} выводит
