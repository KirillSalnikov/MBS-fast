...
`k_eq=20`, 192 ориентации в редуцированном SO(3), `N_phi=288`, `N_theta=144`.
...
|---|---:|---:|---:|---:|
| Точный FP64 | 10,98 с | 1,00 раза | эталон | эталон |
| Точный смешанный FP32 | 6,51 с | 1,69 раза | `9,05e-8` | `4,61e-8` |
| FP32 с fast math | 7,01 с | 1,57 раза | `9,04e-8` | `4,58e-8` |
