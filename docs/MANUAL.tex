...
($k_{\mathrm{eq}}=20$, 192 SO(3) orientations,
...
\bottomrule\noalign{}
\endlastfoot
Precise FP64 & 10.98 s & 1.00 & reference \\
Precise mixed FP32 & 6.51 s & 1.69 & global $L_2=9.05\times10^{-8}$ \\
FP32 with fast math & 7.01 s & 1.57 & global $L_2=9.04\times10^{-8}$ \\
\end{longtable}
...
the warp path. \texttt{MBS\_GPU\_TIMING=1} reports
\texttt{reduction=thread} or \texttt{reduction=warp}.
