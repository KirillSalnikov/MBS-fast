...
class against one full-gamma run. The value $N$ remains the number of actually
traced $\beta,\gamma$ orientations. To retain approximately the same point
density, use half the non-mirror $N$, for example
\texttt{-\/-so3-quaternion 2048 -\/-mirror-gamma} instead of
\texttt{-\/-so3-quaternion 4096}.
