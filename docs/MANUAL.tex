...
Test & Max diff & Notes \\
\midrule
\texttt{--fixed 0 0 --incoh} & $3\times10^{-5}$ & d\_param fix only \\
\texttt{--fixed 0 0 --coh} (no Rotate) & $<10^{-6}$ & exact match \\
HandleBeams inline vs fallback & identical & optimizations verified \\
\bottomrule
\end{tabular}
...
See \texttt{docs/bugfix\_15x\_mismatch.pdf} for the full investigation report.
