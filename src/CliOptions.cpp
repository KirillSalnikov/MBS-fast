...
const std::vector<CliOptionSpec> &GetCliOptionSpecs()
{
    static const std::vector<CliOptionSpec> options = {
        ...
        {"r", "beam-area-ratio", 1, "RATIO", "Geometry",
         "Positive small-beam area restriction ratio; default 100."},
        ...
        {"fft", "fft", 0, "", "Backend",
         "Use experimental cuFFT phi interpolation; requires PO and the CUDA backend."},
        ...
        {"beam_cutoff", "beam-cutoff", 1, "EPS", "Cutoffs",
         "Set both relative output-beam Jones-intensity and area cutoffs."},
        ...
        {"trace_cutoff", "trace-cutoff", 1, "EPS", "Cutoffs",
         "Set both internal tracing Jones-intensity and area pruning cutoffs."},
